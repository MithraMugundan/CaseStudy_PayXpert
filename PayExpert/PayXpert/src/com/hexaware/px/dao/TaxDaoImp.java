...
public class TaxDaoImp implements ITaxDao {
    ...
    public Tax calculateTax(int employeeId, int taxYear) {
        ...
        // Tax calculation logic here (simplified)
        double taxableIncome = 50000.0; // Sample taxable income, should be calculated based on real data
        double taxAmount = taxableIncome * 0.2; // Sample tax calculation, adjust logic as needed
        ...
        try {
            ...
            if (count > 0) {
                tax = new Tax(employeeId, taxYear, count, taxableIncome, taxAmount);
            }
